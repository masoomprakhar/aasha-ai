...
from app.apps.ai.language_utils import normalize_language, resolve_response_language
...
async def get_health_guidance(
    ...
    lang = resolve_response_language(request.query, normalize_language(request.language))
