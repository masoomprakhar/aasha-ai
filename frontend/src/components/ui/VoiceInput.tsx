    ...
    <div className={clsx('flex flex-col items-center gap-3', className)}>
      <button
        ...
        className={clsx(
          ...
          buttonState === 'processing' && 'bg-brand-wash0 focus:ring-indigo-300',
          buttonState === 'speaking' && 'bg-green-500 focus:ring-green-300',
          buttonState === 'idle' && 'bg-brand hover:bg-brand-dark focus:ring-rose-300',
        )}
      >
      ...
      <button
        ...
        className="mt-1 flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-100 text-gray-600 text-xs font-medium hover:bg-gray-200 transition-colors border border-gray-200"
      >
        <Languages size={14} />
