...
import { ttsLocale } from '../utils/language';
...
export default function AshaVoiceRecorder({
    ...
    const { speak, stop: stopSpeaking } = useTextToSpeech(ttsLocale(language));
            ...
            <div className="p-4 space-y-4">
                ...
                {state === 'idle' && (
                    <div className="text-center py-8">
                        ...
                        <motion.button
                            ...
                            className="w-20 h-20 bg-emerald-600 text-white rounded-full flex items-center justify-center mx-auto shadow-lg hover:bg-emerald-700 transition-colors"
                ...
                {state === 'recording' && (
                    <div className="text-center py-8">
                        ...
                        <p className="text-gray-600 mt-2">रिकॉर्डिंग हो रही है...</p>
                ...
                {state === 'processing' && (
                    <div className="text-center py-12">
                        <Loader2 size={48} className="animate-spin text-brand-dark mx-auto" />
                        <p className="text-gray-600 mt-4">आवाज़ प्रोसेस हो रही है...</p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className={clsx(
                            ...
                            <div className="flex-1">
                                ...
                                {followUpQuestion && (
                                    <p className="text-xs mt-1 text-gray-600">{followUpQuestion}</p>
                                )}
                            ...
                            <div className={clsx(
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-700 mt-1">{currentRisk.summary}</p>
                        ...
                        <div className="bg-gray-50 rounded-lg p-3">
                            <p className="text-xs font-bold text-gray-500 uppercase mb-1">जो आपने बोला:</p>
                        ...
                        <div className="space-y-3">
                            ...
                            {/* Symptoms */}
                            <div>
                                <label className="text-xs font-bold text-gray-500 uppercase">लक्षण</label>
                                <input
                                    type="text"
                            ...
                            {/* Observations */}
                            <div>
                                <label className="text-xs font-bold text-gray-500 uppercase">नोट्स / अवलोकन</label>
                                <textarea
                ...
                {state === 'saving' && (
                    <div className="text-center py-12">
                        <Loader2 size={48} className="animate-spin text-brand-dark mx-auto" />
                        <p className="text-gray-600 mt-4">सेव हो रहा है...</p>
                    </div>
                )}
            </div>
        </div>
