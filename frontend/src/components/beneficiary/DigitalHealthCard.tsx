    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-gray-900/80 backdrop-blur-sm">
      ...
      >
        ...
        <div className="p-6 flex flex-col items-center justify-center bg-white">
          ...
          {/* Address Display */}
          <div className="mt-6 w-full bg-gray-50 p-3 rounded-xl border border-gray-100 flex items-center gap-3">
            <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-brand shadow-sm shrink-0">
              <MapPin size={16} />
            </div>
        ...
        {/* Details Grid */}
        <div className="bg-gray-50 p-6 grid grid-cols-2 gap-4 border-t border-gray-100">
          <div>
          ...
          <div>
            ...
            <p className="font-bold text-gray-800">{profile.bloodGroup || '-'}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500 uppercase">Anemia</p>
            <p className="font-bold text-gray-800 capitalize">{profile.anemiaStatus || 'Normal'}</p>
          </div>
        </div>

        {/* Actions */}
        <div className="p-4 border-t border-gray-100 flex gap-3">
          <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-gray-100 rounded-xl font-medium text-gray-700 hover:bg-gray-200">
            <Share2 size={18} /> Share
          </button>
          <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-brand-dark rounded-xl font-medium text-white hover:bg-brand-dark">
