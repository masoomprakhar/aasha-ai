  ...
  return (
    <div className="min-h-screen bg-canvas">
      <nav className="bg-white border-b px-6 py-4 flex items-center gap-4 sticky top-0 z-20">
        <button onClick={() => navigate('/partner/schemes')} className="p-2 hover:bg-gray-100 rounded-full">
          <ArrowLeft className="w-5 h-5 text-gray-600" />
        </button>
        <h1 className="text-xl font-bold text-gray-800">Campaign Dashboard</h1>
      </nav>

      <main className="p-6 max-w-7xl mx-auto space-y-6">
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-3 gap-4 mt-6">
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <div>
                  <p className="text-xs uppercase font-bold text-gray-400">{t('schemes.enrolled')}</p>
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <div>
                  <p className="text-xs uppercase font-bold text-gray-400">{t('partner.budget')}</p>
              ...
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <div>
                  <p className="text-xs uppercase font-bold text-gray-400">Launched</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
            <h3 className="font-bold text-gray-800 mb-6">{t('partner.enrollment_trend')}</h3>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-gray-800">{t('partner.recent_beneficiaries')}</h3>
                  ...
                  return (
                    <div key={enrollment.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Enrolled: {new Date(enrollment.date).toLocaleDateString()}</p>
                      </div>
                    </div>
                  );
                })
