    ...
    return (
        <RoleLayout role="asha_worker" title="Visit Scheduler">
            <div className="space-y-6 pb-24">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div
                        ...
                        className={`p-5 rounded-2xl cursor-pointer transition-all ${filter === 'today' ? 'bg-brand-dark text-white shadow-lg scale-[1.02]' : 'bg-brand-wash text-emerald-800'
                            }`}
                    >
                ...
                <div className="space-y-3">
                    {loading ? (
                        ...
                        <div className="text-center py-12 bg-white rounded-2xl border border-dashed border-gray-300">
                            ...
                            <p className="text-gray-400 text-sm mt-1">Schedule a new visit to get started</p>
                        </div>
                    ) : (
                        visits.map((visit) => (
                            <motion.div
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2 mb-1">
                                                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white ${visit.beneficiaryRiskLevel === 'high' ? 'bg-red-500' :
                                                            visit.beneficiaryRiskLevel === 'medium' ? 'bg-orange-500' : 'bg-brand-dark'
                                                            }`}>
                                            ...
                                            <div className="flex items-center gap-2 mb-3">
                                                ...
                                                {visit.purpose && (
                                                    <span className="text-sm text-gray-500 truncate">• {visit.purpose}</span>
                                                )}
                                            </div>
                                            ...
                                            {visit.status === 'scheduled' && (
                                                <div className="flex gap-2 pt-2 border-t border-gray-100">
                                                    <Button
                                                        size="sm"
                                                        className="flex-1 bg-brand-dark hover:bg-emerald-600"
                                                        onClick={() => {
            ...
            <motion.button
                ...
                className="fixed bottom-24 right-6 w-14 h-14 bg-emerald-600 text-white rounded-full shadow-xl flex items-center justify-center z-40"
            >
                <Plus size={28} />
            </motion.button>
                ...
                {showScheduleModal && (
                    ...
                    >
                        ...
                        >
                            ...
                            <h2 className="text-2xl font-bold text-gray-800 mb-6">Schedule Visit</h2>
                            ...
                            <div className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <select
                                        className="w-full p-4 bg-gray-50 rounded-xl border-none font-medium text-gray-800"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        className="w-full p-4 bg-gray-50 rounded-xl border-none font-medium text-gray-800 resize-none"
                                        rows={3}
