                ...
                <div className="bg-white sticky top-0 z-10 border-b shadow-sm">
                    <div className="p-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="font-bold text-lg text-gray-800">Scheme Management</h1>
                        </div>
                        <button
                ...
                <div className="p-4 space-y-4">
                    ...
                    {schemes.length === 0 ? (
                        <div className="text-center py-12 bg-white rounded-xl border border-dashed border-gray-200">
                            ...
                            <p className="text-gray-400">No active schemes available</p>
                        </div>
                    ) : (
                                ...
                                <div className="p-4 border-b bg-emerald-600 text-white">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-emerald-100 text-sm">Select beneficiaries to enroll</p>
                                        </div>
                                        <button
                                            onClick={() => setShowEnrollModal(false)}
                                    ...
                                    <div className="mt-3 relative">
                                        <Search className="absolute left-3 top-2.5 text-emerald-200 w-5 h-5" />
                                        <input
                                            type="text"
                                            placeholder="Search beneficiaries..."
                                            value={search}
                                            onChange={(e) => setSearch(e.target.value)}
                                            className="w-full pl-10 pr-4 py-2 bg-white/10 border border-white/20 rounded-xl text-white placeholder-emerald-200 focus:outline-none focus:ring-2 focus:ring-white/30"
                                        />
                                    </div>
                                </div>
