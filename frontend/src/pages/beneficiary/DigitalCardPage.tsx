...
export default function BeneficiaryProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-canvas flex flex-col">
      <div className="p-4 flex items-center justify-between bg-white dark:bg-gray-900 sticky top-0 z-20 shadow-sm">
        ...
        <button 
          ...
          className={`p-2 rounded-full transition-colors ${isEditing ? 'bg-brand-soft/40 text-brand-dark' : 'hover:bg-gray-100 text-gray-600'}`}
        >
      ...
      <div className="flex-1 p-6 overflow-y-auto pb-24">
        <div className="max-w-md mx-auto space-y-6">
          ...
          {/* Header Card */}
          <div className="bg-white dark:bg-gray-900 rounded-3xl overflow-hidden shadow-xl shadow-gray-200 dark:shadow-gray-900/50">
            <div className="bg-lunari-gradient p-6 text-white text-center relative">
              ...
              <button 
                ...
                className="mt-6 inline-flex items-center gap-2 px-6 py-3 bg-white text-brand-dark rounded-full font-bold text-sm shadow-lg hover:scale-105 transition-transform hover:bg-gray-50"
              >
          ...
          {/* Care Team Section */}
          <GlassCard className="p-5 bg-brand-wash border-indigo-100">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-bold text-gray-900">{linkedAsha?.name || 'Priya ASHA'}</p>
                </div>
                <button className="p-2 bg-white rounded-full text-brand hover:bg-indigo-100 transition-colors">
                  <Phone size={16} />
                </button>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="font-bold text-gray-900">District Hospital, Sector 4</p>
                </div>
                <button className="p-2 bg-white rounded-full text-brand hover:bg-indigo-100 transition-colors">
                  <MapPin size={16} />
                </button>
          ...
          <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <GlassCard className="p-4 flex flex-col justify-between h-32">
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-3xl font-bold text-gray-800 dark:text-white">
                      {profile.weight || '-'} <span className="text-sm text-gray-400 font-normal">kg</span>
                    </p>
                  )}
                </GlassCard>
                  ...
                  {isEditing ? (
                    <div className="flex items-end gap-1">
                      <input 
                        ...
                        className="w-full text-3xl font-bold bg-transparent border-b-2 border-emerald-200 focus:border-emerald-500 outline-none"
                      />
                      <span className="text-sm text-gray-400 mb-1">cm</span>
                    </div>
                  ) : (
                    <p className="text-3xl font-bold text-gray-800 dark:text-white">
                      {profile.height || '-'} <span className="text-sm text-gray-400 font-normal">cm</span>
                    </p>
                  )}
                </GlassCard>
                ...
                <GlassCard className="p-4 flex flex-col justify-between h-32 col-span-2">
                  ...
                  {isEditing ? (
                    <select 
                      ...
                      className="w-full p-2 rounded-lg bg-gray-50 border border-gray-200 text-sm font-bold outline-none"
                    >
                ...
                <GlassCard className="p-4 col-span-2">
                  ...
                  {isEditing ? (
                    ...
                    <div>
                      <p className="text-sm font-bold text-gray-800">{profile.address || 'No address set'}</p>
                      {profile.gps_coords && (
                ...
                <GlassCard className="p-5">
                  ...
                  {isEditing ? (
                    <select 
                      ...
                      className="w-full p-3 rounded-xl bg-gray-50 border border-gray-200 text-sm font-bold"
                    >
            ...
            {activeTab === 'family' && (
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <GlassCard className="p-5 flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">{child.dob} • {child.bloodGroup || 'N/A'}</p>
                        </div>
                      </div>
                ...
                {isAddingChild ? (
                  <GlassCard className="p-5 bg-gray-50 border-dashed border-2 border-gray-300">
                    <h3 className="font-bold text-gray-800 mb-4">Add Child</h3>
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 mt-2">
                        <button onClick={() => setIsAddingChild(false)} className="flex-1 py-2 text-gray-500 font-bold">Cancel</button>
                        <button onClick={handleAddChild} className="flex-1 py-2 bg-gray-900 text-white rounded-xl font-bold">Save</button>
                      </div>
                    </div>
                  </GlassCard>
                ) : (
                  <button 
                    ...
                    className="w-full py-4 border-2 border-dashed border-gray-300 rounded-2xl text-gray-400 font-bold flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors"
                  >
