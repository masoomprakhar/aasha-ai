...
const GIRL_USERS: User[] = [
  ...
  { id: 'g11', name: 'Radha Kumari', role: 'beneficiary' },
  { id: 'g12', name: 'Muskan Devi', role: 'beneficiary' },
  { id: 'g13', name: 'Sakshi Gupta', role: 'beneficiary' },
  { id: 'g14', name: 'Komal Singh', role: 'beneficiary' },
  { id: 'g15', name: 'Nidhi Mishra', role: 'beneficiary' },
];
...
export const MOCK_BENEFICIARIES: BeneficiaryProfile[] = [
  { id: 'b01', userId: 'g01', name: 'Priya Sharma', userType: 'girl', age: 17, height: 155, weight: 48, bloodGroup: 'B+', lastPeriodDate: '2025-05-02', anemiaStatus: 'mild', riskLevel: 'low', linkedAshaId: 'a01', nextCheckup: '2025-06-20', economicStatus: 'bpl', address: 'Village Rampur, Block Hajipur, Bihar' },
  { id: 'b02', userId: 'g02', name: 'Ananya Singh', userType: 'girl', age: 16, height: 152, weight: 45, bloodGroup: 'O+', lastPeriodDate: '2025-04-18', anemiaStatus: 'moderate', riskLevel: 'medium', linkedAshaId: 'a01', nextCheckup: '2025-06-18', economicStatus: 'bpl', address: 'Village Chakia, East Champaran, Bihar' },
  ...
  { id: 'b04', userId: 'g04', name: 'Riya Verma', userType: 'girl', age: 15, height: 150, weight: 42, bloodGroup: 'AB+', lastPeriodDate: '2025-03-28', anemiaStatus: 'mild', riskLevel: 'medium', linkedAshaId: 'a02', nextCheckup: '2025-06-15', economicStatus: 'bpl', address: 'Village Sitapur, Uttar Pradesh' },
  ...
  { id: 'b06', userId: 'g06', name: 'Divya Yadav', userType: 'girl', age: 16, height: 153, weight: 46, bloodGroup: 'O-', lastPeriodDate: '2025-04-05', anemiaStatus: 'severe', riskLevel: 'high', linkedAshaId: 'a03', nextCheckup: '2025-06-12', economicStatus: 'bpl', address: 'Village Muzaffarpur, Bihar' },
  ...
  { id: 'b08', userId: 'g08', name: 'Neha Rai', userType: 'girl', age: 18, height: 157, weight: 49, bloodGroup: 'B+', lastPeriodDate: '2025-05-12', anemiaStatus: 'moderate', riskLevel: 'medium', linkedAshaId: 'a05', nextCheckup: '2025-06-21', economicStatus: 'bpl', address: 'Village Madhubani, Bihar' },
  ...
  { id: 'b11', userId: 'g11', name: 'Radha Kumari', userType: 'girl', age: 16, height: 151, weight: 43, bloodGroup: 'B+', lastPeriodDate: '2025-05-06', anemiaStatus: 'mild', riskLevel: 'low', linkedAshaId: DEMO_ASHA_WORKER_ID, nextCheckup: '2025-06-24', economicStatus: 'bpl', address: 'Village Bettiah, West Champaran, Bihar', medicalHistory: 'Mild anemia since age 14', currentMedications: 'Weekly IFA tablets' },
  { id: 'b12', userId: 'g12', name: 'Muskan Devi', userType: 'girl', age: 17, height: 154, weight: 46, bloodGroup: 'O+', lastPeriodDate: '2025-04-12', anemiaStatus: 'moderate', riskLevel: 'medium', linkedAshaId: DEMO_ASHA_WORKER_ID, nextCheckup: '2025-06-19', economicStatus: 'bpl', address: 'Village Motihari, East Champaran, Bihar', medicalHistory: 'Irregular periods for 3 months', currentMedications: 'IFA + calcium' },
  { id: 'b13', userId: 'g13', name: 'Sakshi Gupta', userType: 'girl', age: 15, height: 148, weight: 40, bloodGroup: 'A+', lastPeriodDate: '2025-03-20', anemiaStatus: 'severe', riskLevel: 'high', linkedAshaId: DEMO_ASHA_WORKER_ID, nextCheckup: '2025-06-14', economicStatus: 'bpl', address: 'Village Samastipur, Bihar', medicalHistory: 'Severe anemia, low appetite', currentMedications: 'Double-dose IFA under supervision' },
  { id: 'b14', userId: 'g14', name: 'Komal Singh', userType: 'girl', age: 18, height: 159, weight: 51, bloodGroup: 'AB+', lastPeriodDate: '2025-05-18', anemiaStatus: 'normal', riskLevel: 'low', linkedAshaId: DEMO_ASHA_WORKER_ID, nextCheckup: '2025-06-28', economicStatus: 'apl', address: 'Village Bhagalpur, Bihar' },
  { id: 'b15', userId: 'g15', name: 'Nidhi Mishra', userType: 'girl', age: 16, height: 152, weight: 44, bloodGroup: 'B-', lastPeriodDate: '2025-05-03', anemiaStatus: 'mild', riskLevel: 'medium', linkedAshaId: DEMO_ASHA_WORKER_ID, nextCheckup: '2025-06-21', economicStatus: 'bpl', address: 'Village Siwan, Bihar', medicalHistory: 'Heavy bleeding during periods', currentMedications: 'IFA tablets' },
];
...
export const MOCK_ALERTS: Alert[] = [
  ...
  { id: 'al05', beneficiaryId: 'b13', severity: 'high', status: 'open', timestamp: new Date().toISOString(), type: 'health_risk', reason: 'Severe anemia — missed IFA for 10 days' },
  { id: 'al06', beneficiaryId: 'b12', severity: 'medium', status: 'open', timestamp: new Date(Date.now() - 86400000).toISOString(), type: 'health_risk', reason: 'Irregular cycle — 52 days since last period' },
  { id: 'al07', beneficiaryId: 'b15', severity: 'medium', status: 'open', timestamp: new Date(Date.now() - 43200000).toISOString(), type: 'sos', reason: 'Reported heavy bleeding and dizziness' },
];
...
export const MOCK_HEALTH_LOGS: HealthLog[] = [
  ...
  { id: 'h04', beneficiaryId: 'b11', date: new Date().toISOString(), bpSystolic: 108, bpDiastolic: 68, symptoms: ['fatigue'], mood: 'Neutral', isEmergency: false },
  { id: 'h05', beneficiaryId: 'b13', date: new Date().toISOString(), bpSystolic: 98, bpDiastolic: 62, symptoms: ['dizziness', 'pallor', 'weakness'], mood: 'Weak', isEmergency: true },
  { id: 'h06', beneficiaryId: 'b15', date: new Date(Date.now() - 43200000).toISOString(), bpSystolic: 106, bpDiastolic: 70, symptoms: ['heavy bleeding', 'fatigue'], mood: 'Anxious', isEmergency: false },
];
